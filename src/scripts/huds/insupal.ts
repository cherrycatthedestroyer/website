...
class Insupal extends Project {

    constructor(p5:p5Type,width:number, height:number) {
        super(p5,"INSUPAL",width,height);
        this.hudType="insupal";
        this.escPage="mediaSearch";
        this.info1= new BodyText("I directed, voice and produced this an app I developed with a team.\nI used figma to design the graphics, After Effects to animate the\nscenes and Premiere to sequence and design/record sound.\nThe app itself was developed in Swift and I designed the interface."
        ,13,width,height,p5);
        this.stack=new BodyText(". Figma\n. After Effects\n. Premiere",13,width,height,p5);

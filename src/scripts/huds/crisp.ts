...
class Crisp extends Project {

    constructor(p5:p5Type,width:number, height:number) {
        super(p5,"CRISP",width,height);
        this.hudType="crisp";
        this.escPage="mediaSearch";
        this.info1= new BodyText("I directed, voice and produced this app trailer for a client.\nI used figma to design the graphics, After Effects to animate\nthe scenes and Premiere to sequence and design sound.\nThe app is an AI soloution for accesible healthcare."
        ,13,width,height,p5);

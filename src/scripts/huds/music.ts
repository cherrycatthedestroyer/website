...
class Music extends HUD {
    ...
    constructor(p5:p5Type,width:number,height:number) {
        ...
        this.track1= new SmallText("Disco In The Park          "+this.track1Time,15,width,height,p5);
        this.track2= new SmallText("LoLuV                      "+this.track2Time,15,width,height,p5);
        this.track3= new SmallText("Black Flume                "+this.track3Time,15,width,height,p5);
        this.prompt1= new PromptText("Press ENTER to play/pause",15,width,height,p5);

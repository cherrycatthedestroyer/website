...
class Fishingsim extends Project {
    ...
    constructor(p5:p5Type,width:number, height:number) {
        super(p5,"assets/cleaned/fishingsim_logo.gif",width,height);
        this.info=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/fishingsim_info.gif", p5, 0,width,height);
        this.stack=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/fishingsim_stack.gif", p5, 0,width,height);
        this.link=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/fishingsim_prompt.gif", p5, 0,width,height);
    ...
    show(p5: p5Type) {
        ...
        if (this.state=="boot"||this.state=="on"||this.state=="close"){
            ...
            if (this.elementCount==0){
                this.info.show(p5,-215,-205);
            }
            else if (this.elementCount==1){
                this.stack.show(p5,-225,-200);
            }

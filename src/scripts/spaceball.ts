...
class Spaceball extends Project {
    ...
    constructor(p5:p5Type,width:number, height:number) {
        super(p5,"assets/cleaned/spaceball_logo.gif",width,height);
        this.info=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/spaceball_info.gif", p5, 0,width,height);
        this.stack=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/spaceball_stack.gif", p5, 0,width,height);
        this.link=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/spaceball_prompt.gif", p5, 0,width,height);
    ...
    show(p5: p5Type) {
        ...
        if (this.state=="boot"||this.state=="on"||this.state=="close"){
            ...
            if (this.elementCount==0){
                ...
                this.stack.show(p5,-215,-165);
            }
            else if (this.elementCount==2){
                this.link.show(p5,-70,-110);
            }
        }
        p5.pop();
    }

...
class Vibecheck extends Project {
    ...
    constructor(p5:p5Type,width:number, height:number) {
        super(p5,"assets/cleaned/vibecheck_logo.gif",width,height);
        this.info=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/vibecheck_info.gif", p5, 0,width,height);
        this.stack=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/vibecheck_stack.gif", p5, 0,width,height);
        this.link=new Element("assets/cleaned/placeholder.png",
        "assets/cleaned/vibecheck_prompt.gif", p5, 0,width,height);
    ...
    show(p5: p5Type) {
        ...
        if (this.state=="boot"||this.state=="on"||this.state=="close"){
            ...
            if (this.elementCount==0){
                this.info.show(p5,-220,-195);
            }
            else if (this.elementCount==1){
                this.stack.show(p5,-215,-200);
            }
